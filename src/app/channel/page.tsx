        ...
        <main className="flex-1 overflow-y-auto p-4 pt-0 custom-scrollbar">
          ...
          <div className="px-8 -mt-12 flex flex-col md:flex-row items-end gap-6 mb-12">
            <Avatar className="h-32 w-32 border-4 border-black rounded-3xl shadow-2xl shadow-emerald-500/10">
              ...
              <AvatarFallback className="text-4xl bg-zinc-900 text-emerald-500">
                C
              </AvatarFallback>
            </Avatar>
            ...
            <div className="flex-1 pb-2">
              ...
              <div className="flex items-center gap-4 text-xs text-zinc-500 font-body">
                ...
                <span className="flex items-center gap-2 tracking-tighter">
                  <Users size={14} /> 0 CONNECTED
                </span>
                <span className="flex items-center gap-2 tracking-tighter">
                  <Video size={14} /> {channelVideos.length} NODES
                </span>
              </div>
            </div>
          ...
          <div className="px-4">
            <div className="flex items-center gap-8 border-b border-emerald-500/10 mb-8">
              <button className="pb-4 border-b-2 border-emerald-500 text-emerald-500 font-bold text-[10px] uppercase tracking-[0.2em]">
                Live Transmissions
              </button>
              <button className="pb-4 text-zinc-600 hover:text-emerald-400 font-bold text-[10px] uppercase tracking-[0.2em] transition-colors">
                Mesh Logs
              </button>
            </div>
            ...
            {channelVideos.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 opacity-10 text-center">
                ...
                <p className="font-headline font-bold uppercase tracking-widest text-xs text-emerald-500">
                  No Mesh Signals Detected
                </p>
              </div>
            )}
          </div>
    ...
    <Suspense
      fallback={
        <div className="flex flex-col h-screen bg-black items-center justify-center gap-4">
          <Loader2 className="animate-spin text-emerald-500" size={40} />
          <p className="font-code text-[10px] tracking-widest text-emerald-500 uppercase animate-pulse">
