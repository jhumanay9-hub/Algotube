      ...
      <div className="glass-card rounded-2xl overflow-hidden h-full flex flex-col">
        ...
        <div className="p-4 flex flex-col flex-1">
          <div className="flex gap-3 mb-2">
            <div className="w-8 h-8 rounded-lg bg-primary/20 border border-white/5 flex-shrink-0 flex items-center justify-center text-[10px] font-bold text-accent">
              {video.creator[0]}
            </div>
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground mt-1 truncate">{video.creator}</p>
            </div>
