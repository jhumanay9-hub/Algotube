  ...
  if (hasError) {
    return (
      <div className="aspect-video bg-black rounded-3xl border border-red-500/20 flex flex-col items-center justify-center gap-4 text-center p-6">
        ...
        <div>
          <h3 className="text-white font-headline font-bold uppercase tracking-widest text-sm mb-2">Video Not Found</h3>
          <p className="text-[10px] text-muted-foreground font-code max-w-xs">The requested media asset could not be retrieved from the local server registry (404).</p>
        </div>
      </div>
    );
  }
