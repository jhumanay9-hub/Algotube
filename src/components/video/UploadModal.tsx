  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Transmission physical binary stored.",
      });
        ...
        <form onSubmit={handleUpload} className="p-8 pt-0 space-y-6">
            ...
            >
              ...
              <div className="text-center">
                <p className="font-bold text-sm text-white">
                  Select Transmission File
                </p>
                <p className="text-[10px] text-muted-foreground mt-1 uppercase font-code">
                  SQL Metadata Mode
                </p>
              </div>
            </div>
          ...
          <div className="flex gap-3">
            <Button
              ...
              variant="ghost"
              onClick={onClose}
              className="flex-1 rounded-xl font-bold text-[11px] uppercase"
              disabled={isProcessing}
            >
              CANCEL
            </Button>
            <Button
              ...
              disabled={
                (!selectedFile && !isProcessing) || !title || isProcessing
              }
            >
